...
<!--
CUSTOMIZATION: Replace {domain} with your agent's domain.
Examples: github/, healthcare/, finance/, fleet/

Then create your domain directories:
  mkdir -p knowledge/github/patterns knowledge/github/heuristics
...
---
*From AGET v3.0.0 aget/components/knowledge/README_TEMPLATE.md*
